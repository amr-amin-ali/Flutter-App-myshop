  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (error.toString().contains('EMAIL_EXISTS')) {
        _showErrorDialog('this email already exist in our database');
      } else if (error.toString().contains('INVALID_EMAIL')) {
        _showErrorDialog('this is not a valid email address');
      } else if (error.toString().contains('WEAK_PASSWORD')) {
        _showErrorDialog('this password is too weak');
      } else if (error.toString().contains('EMAIL_NOT_FOUND')) {
        _showErrorDialog('could not find  user with this email');
      } else if (error.toString().contains('INVALID_PASSWORD')) {
        _showErrorDialog('this password is invalid');
      } else {
